...
Shader "DawnShaderHDRP/EyesGradianShaderHDRP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_AlphaMap = packedInput.ase_texcoord5.xy * _AlphaMap_ST.xy + _AlphaMap_ST.zw;
				...
				surfaceDescription.Albedo = ( _ShadowColor * tex2DNode1.a ).rgb;
				...
				#ifdef _ALPHATEST_ON
				surfaceDescription.AlphaClipThreshold = ( 1.0 - ( _OpacityBoots * dither6 ) );
				#endif
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_AlphaMap = packedInput.ase_texcoord.xy * _AlphaMap_ST.xy + _AlphaMap_ST.zw;
				float4 tex2DNode1 = tex2D( _AlphaMap, uv_AlphaMap );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_AlphaMap = packedInput.ase_texcoord1.xy * _AlphaMap_ST.xy + _AlphaMap_ST.zw;
				float4 tex2DNode1 = tex2D( _AlphaMap, uv_AlphaMap );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_AlphaMap = packedInput.ase_texcoord3.xy * _AlphaMap_ST.xy + _AlphaMap_ST.zw;
				float4 tex2DNode1 = tex2D( _AlphaMap, uv_AlphaMap );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_AlphaMap = packedInput.ase_texcoord7.xy * _AlphaMap_ST.xy + _AlphaMap_ST.zw;
				float4 tex2DNode1 = tex2D( _AlphaMap, uv_AlphaMap );
...
WireConnection;24;9;1;4
WireConnection;24;10;21;0
ASEEND*/
//CHKSM=4B453DE2CE9291EEE558BE3F99B8068800757CE3