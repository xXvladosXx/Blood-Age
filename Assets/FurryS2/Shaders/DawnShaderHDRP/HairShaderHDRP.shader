...
Shader "DawnShaderHDRP/HairShaderHDRP"
{
	Properties
	{
		...
		_RoughnessBoost("Roughness Boost", Range( 0 , 5)) = 0.25
		...
		_OpacityBoost("Opacity Boost", Range( 0 , 1)) = 0.94
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local _USEBASECOLOR_ON
						...
						)
			{
				...
				float2 uv_HairAlpha = packedInput.ase_texcoord5.xy * _HairAlpha_ST.xy + _HairAlpha_ST.zw;
				float4 tex2DNode2 = tex2Dbias( _HairAlpha, float4( uv_HairAlpha, 0, _MipBias) );
				float4 lerpResult82 = lerp( _RootColor , _TipColor , tex2DNode2.a);
				#ifdef _USEBASECOLOR_ON
				float4 staticSwitch142 = tex2DNode2;
				#else
				float4 staticSwitch142 = lerpResult82;
				#endif
				
				float4 lerpResult64 = lerp( _TangentA , _TangentB , tex2DNode2.a);
				float4 normalizeResult65 = normalize( lerpResult64 );
				
				float lerpResult73 = lerp( 0.0 , _RoughnessBoost , tex2DNode2.a);
				...
				surfaceDescription.Albedo = ( _Brighness * ( staticSwitch142 * tex2D( _NoiseTexture, ( packedInput.ase_texcoord5.xy * _NoiseTilling ) ).r ) ).rgb;
				surfaceDescription.Normal = normalizeResult65.rgb;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = ( _SpecularTint * tex2DNode2.a );
				...
				surfaceDescription.Smoothness = lerpResult73;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = ( tex2DNode2.a * _OpacityBoost );

				#ifdef _ALPHATEST_ON
				surfaceDescription.AlphaClipThreshold = ( 1.0 - dither92 );
				#endif
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_HairAlpha = packedInput.ase_texcoord.xy * _HairAlpha_ST.xy + _HairAlpha_ST.zw;
				float4 tex2DNode2 = tex2Dbias( _HairAlpha, float4( uv_HairAlpha, 0, _MipBias) );
				float4 lerpResult82 = lerp( _RootColor , _TipColor , tex2DNode2.a);
				#ifdef _USEBASECOLOR_ON
				float4 staticSwitch142 = tex2DNode2;
				...
				surfaceDescription.Albedo = ( _Brighness * ( staticSwitch142 * tex2D( _NoiseTexture, ( packedInput.ase_texcoord.xy * _NoiseTilling ) ).r ) ).rgb;
				surfaceDescription.Normal = normalizeResult65.rgb;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = ( _SpecularTint * tex2DNode2.a );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_HairAlpha = packedInput.ase_texcoord1.xy * _HairAlpha_ST.xy + _HairAlpha_ST.zw;
				float4 tex2DNode2 = tex2Dbias( _HairAlpha, float4( uv_HairAlpha, 0, _MipBias) );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_HairAlpha = packedInput.ase_texcoord3.xy * _HairAlpha_ST.xy + _HairAlpha_ST.zw;
				float4 tex2DNode2 = tex2Dbias( _HairAlpha, float4( uv_HairAlpha, 0, _MipBias) );
				float4 lerpResult64 = lerp( _TangentA , _TangentB , tex2DNode2.a);
				float4 normalizeResult65 = normalize( lerpResult64 );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_HairAlpha = packedInput.ase_texcoord7.xy * _HairAlpha_ST.xy + _HairAlpha_ST.zw;
				float4 tex2DNode2 = tex2Dbias( _HairAlpha, float4( uv_HairAlpha, 0, _MipBias) );
				float4 lerpResult82 = lerp( _RootColor , _TipColor , tex2DNode2.a);
				#ifdef _USEBASECOLOR_ON
				float4 staticSwitch142 = tex2DNode2;
				...
				surfaceDescription.Albedo = ( _Brighness * ( staticSwitch142 * tex2D( _NoiseTexture, ( packedInput.ase_texcoord7.xy * _NoiseTilling ) ).r ) ).rgb;
				surfaceDescription.Normal = normalizeResult65.rgb;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = ( _SpecularTint * tex2DNode2.a );
...
/*ASEBEGIN
Version=18900
2560;0;2560;1059;2149.016;311.548;1.3;True;True
Node;AmplifyShaderEditor.CommentaryNode;74;-1771.874,-451.9984;Inherit;False;1184.027;869.6328;Base Color;13;85;84;83;82;81;79;78;77;76;75;2;55;142;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;86;-1844.317,475.8812;Inherit;False;1146.538;473.4188;Opacity;6;92;90;89;87;105;118;;1,1,1,1;0;0
Node;AmplifyShaderEditor.ColorNode;78;-1314.637,6.081722;Float;False;Property;_TipColor;Tip Color;7;0;Create;True;0;0;0;False;0;False;0.1226415,0.06746172,0.03297437,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;82;-1013.662,-84.5217;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;87;-1784.088,722.9722;Float;False;Property;_DitherBoost;Dither Boost;12;0;Create;True;0;0;0;False;0;False;1;2.72;0;4;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;68;-623.5835,522.3861;Inherit;False;796.5378;398.6938;Roughness;2;73;71;;1,1,1,1;0;0
Node;AmplifyShaderEditor.ColorNode;60;-207.1383,-318.2082;Float;False;Property;_TangentA;TangentA;9;0;Create;True;0;0;0;False;0;False;0,0.1543091,0.5568628,0.003921569;0,0.1543091,0.5568628,0.003921569;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;142;-855.5164,-184.1482;Inherit;False;Property;_UseBaseColor;UseBaseColor;3;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;59;-206.1383,-144.2076;Float;False;Property;_TangentB;TangentB;10;0;Create;True;0;0;0;False;0;False;0,0.7781801,1,0.003921569;1,0.7653513,0,0.003921569;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;89;-1533.935,544.8862;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;71;-605.3161,714.6874;Float;False;Property;_RoughnessBoost;Roughness Boost;4;0;Create;True;0;0;0;False;0;False;0.25;0.22;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;70;-259.4961,401.6363;Float;False;Property;_SpecularTint;Specular Tint;8;0;Create;True;0;0;0;False;0;False;0.7;0.5;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;90;-1783.138,803.327;Float;False;Property;_OpacityBoost;Opacity Boost;11;0;Create;True;0;0;0;False;0;False;0.94;3.7;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DitheringNode;92;-1388.276,540.2355;Inherit;False;0;True;4;0;FLOAT;0;False;1;SAMPLER2D;;False;2;FLOAT4;0,0,0,0;False;3;SAMPLERSTATE;;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;105;-884.7114,526.452;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;118;-1458.792,747.7589;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
WireConnection;64;2;2;4
WireConnection;83;0;142;0
WireConnection;83;1;81;1
WireConnection;92;0;89;0
WireConnection;105;0;92;0
WireConnection;118;0;2;4
WireConnection;118;1;90;0
WireConnection;85;0;84;0
WireConnection;85;1;83;0
WireConnection;72;0;70;0
WireConnection;72;1;2;4
WireConnection;65;0;64;0
WireConnection;73;1;71;0
WireConnection;73;2;2;4
WireConnection;131;0;85;0
WireConnection;131;1;65;0
WireConnection;131;4;72;0
WireConnection;131;7;73;0
WireConnection;131;9;118;0
WireConnection;131;10;105;0
ASEEND*/
//CHKSM=02D7FB9B553515C7399F37737EC8828B88BE6013