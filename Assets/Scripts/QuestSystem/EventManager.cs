...
public class EventManager : MonoBehaviour {
    ...
    public delegate void EventDelegate<T> (T e) where T : EventTrigger.TriggerEvent;
    private delegate void EventDelegate (EventTrigger.TriggerEvent e);
    ...
    private EventDelegate AddDelegate<T>(EventDelegate<T> del) where T : EventTrigger.TriggerEvent {
    ...
    public void AddListener<T> (EventDelegate<T> del) where T : EventTrigger.TriggerEvent {
        AddDelegate<T>(del);
    }

    public void AddListenerOnce<T> (EventDelegate<T> del) where T : EventTrigger.TriggerEvent {
    ...
    public void RemoveListener<T> (EventDelegate<T> del) where T : EventTrigger.TriggerEvent {
    ...
    public bool HasListener<T> (EventDelegate<T> del) where T : EventTrigger.TriggerEvent {
        return delegateLookup.ContainsKey(del);
    }

    public void TriggerEvent (EventTrigger.TriggerEvent e) {
        EventDelegate del;
    ...
    public bool QueueEvent(EventTrigger.TriggerEvent evt) {
    ...
    void Update() {
        ...
        while (m_eventQueue.Count > 0) {
            ...
            EventTrigger.TriggerEvent evt = m_eventQueue.Dequeue() as EventTrigger.TriggerEvent;
            TriggerEvent(evt);
