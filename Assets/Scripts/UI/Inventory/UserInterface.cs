...
namespace InventorySystem
{
    ...
    public abstract class UserInterface : MonoBehaviour
    {
        ...
        public event Action OnInterfaceEnter;
        public event Action OnInterfaceExit;
        ...
        public event Action<Item> OnItemOverlap; 
        ...
        {
            _mouseData.UI = null;
            OnInterfaceExit?.Invoke();
        }

        private void OnEnterInterface(GameObject o)
        {
            OnInterfaceEnter?.Invoke();
            _mouseData.UI = o.GetComponent<UserInterface>();
        }

        protected void OnEnter(GameObject o)
        {
            var item = inventory.FindNecessaryItem(SlotOnUI[o].ItemData.Id);
            OnItemOverlap?.Invoke(item);
